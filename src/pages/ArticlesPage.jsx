...
export const ArticlesPage = () => {
    ...
    return (
        <section className='h-full flex justify-center items-center gap-x-8 px-5 lg:px-20 bg-gray-800'>
            ...
            <article className="w-full sm:w-1/2 lg:w-1/4 flex flex-col justify-between rounded-lg shadow-lg bg-white my-5">
                <div className='w-full flex items-center justify-center bg-blue-700 text-white text-xl font-semibold rounded-t-lg p-2'>
                    <h2 className='text-center'>Indicadores de Lucratividade</h2>
                </div>
                <p className="w-full text-gray-700 text-center p-2">
                    Aprenda a interpretar os principais indicadores fundamentalistas de lucratividade e decida, por conta própria, se você deve investir em determinada empresa ou não.
                </p>
                <Link
